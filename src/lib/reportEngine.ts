...
export const CODE_TO_TYPE: Record<string, string> = { Em: 'Empathy', Cr: 'Creative', Op: 'Operative', Ar: 'Architect' };
export const TYPE_TO_CODE: Record<string, string> = { Empathy: 'Em', Creative: 'Cr', Operative: 'Op', Architect: 'Ar' };
export const CODE_TO_EN: Record<string, string> = { Em: 'Connector', Cr: 'Creator', Op: 'Supporter', Ar: 'Architect' };

export function computeAll(data?: any) {
  if (!data) {
...
export function buildAcquiredAnalysisPage(jobFits: any[], r: any, coreJobs: any[], compNames: any, calcNadaum: any, jobMapping: any[]): string {
...
export function replaceTemplate(html: string, r: any): string {
